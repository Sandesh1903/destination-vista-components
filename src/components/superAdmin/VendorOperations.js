...
// import React from "react";
// import "bootstrap/dist/css/bootstrap.min.css";
// import { FaUsers, FaCheckCircle, FaClock, FaDollarSign, FaEdit, FaTrashAlt } from "react-icons/fa";
...
//       <div className="d-flex justify-content-between align-items-center mb-4">
//         <h2 className="fw-bold text-primary">Vendor Operations</h2>
//         <button className="btn btn-primary shadow-sm">+ Add New Vendor</button>
//       </div>

      
//       <div className="row g-3">
//         {[
//           { title: "Total Vendors", value: "145", icon: <FaUsers />, color: "primary" },
//           { title: "Active Vendors", value: "120", icon: <FaCheckCircle />, color: "success" },
//           { title: "Pending Approval", value: "25", icon: <FaClock />, color: "warning" },
//           { title: "Total Revenue", value: "$45,289", icon: <FaDollarSign />, color: "info" },
//         ].map((item, index) => (
//           <div className="col-md-3" key={index}>
//             <div className={`card text-center border-0 shadow-sm bg-light`}>
//               <div className="card-body">
//                 <div className={`text-${item.color} display-6 mb-2`}>{item.icon}</div>
